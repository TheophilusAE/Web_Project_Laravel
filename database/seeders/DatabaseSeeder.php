...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::create([
            ...
            'role' => 'UMKM Owner',
            'business_name' => 'Sample UMKM Business',
        ...
        $articles = [
            [
                'title' => 'Getting Started with Financial Planning for UMKM',
                'content' => '<h2>Introduction</h2><p>Financial planning is crucial for the success of any UMKM business. This guide will help you understand the basics of financial management and how to implement them in your business.</p><h2>Key Points</h2><ul><li>Track your income and expenses</li><li>Set financial goals</li><li>Create a budget</li><li>Monitor cash flow</li></ul>',
            ...
            [
                ...
                'content' => '<h2>What is Cash Flow?</h2><p>Cash flow is the movement of money in and out of your business. Understanding and managing cash flow is essential for business survival and growth.</p><h2>Tips for Better Cash Flow</h2><ul><li>Invoice promptly</li><li>Monitor expenses</li><li>Maintain emergency funds</li><li>Plan for seasonal fluctuations</li></ul>',
